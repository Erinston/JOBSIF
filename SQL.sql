...
CREATE TABLE TIMES(
	...
	PONTOS INT(10),
	NOME VARCHAR (40) NOT NULL,
 /*fazer um descricao que ira colocar os outros usuarios*/
...
insert into MODALIDADES(nome) values
    ...
    insert into usuarios(MATRICULA,NOME,TELEFONE,USUARIO,SENHA, TIPOS_USER) values ('101010','Adm','0800','adm','adm123',1);